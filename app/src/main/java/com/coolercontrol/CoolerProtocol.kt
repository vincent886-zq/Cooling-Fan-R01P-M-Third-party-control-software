...
object CoolerProtocol {
    ...
    val AUTH_FRAMES: List<ByteArray> = listOf(
        byteArrayOf(
            0xFE.toByte(), 0xDC.toByte(), 0xBA.toByte(), 0xC0.toByte(), 0x50, 0x00, 0x12,
            0x9B.toByte(), 0x01, 0xF5.toByte(), 0x8E.toByte(),
            0x94.toByte(), 0x9E.toByte(), 0xF4.toByte(), 0x6F, 0x0F,
            0xB3.toByte(), 0x3B, 0x42, 0xDD.toByte(), 0x4E,
            0xBA.toByte(), 0xC8.toByte(), 0xB7.toByte(), 0x0F, 0xEF.toByte()
        ),
        byteArrayOf(
            0xFE.toByte(), 0xDC.toByte(), 0xBA.toByte(), 0xC0.toByte(), 0x51, 0x00, 0x03,
            0x01, 0x01, 0x00, 0xEF.toByte()
        ),
        byteArrayOf(
            0xFE.toByte(), 0xDC.toByte(), 0xBA.toByte(), 0xC1.toByte(), 0x50, 0x00, 0x12,
        ...
        byteArrayOf(
            0xFE.toByte(), 0xDC.toByte(), 0xBA.toByte(), 0xC1.toByte(), 0x51, 0x00, 0x03,
            0x6A, 0x01, 0x00, 0xEF.toByte()
        )
    )

    val INIT_FRAMES: List<ByteArray> = listOf(
        byteArrayOf(0xFE.toByte(), 0xDC.toByte(), 0xBA.toByte(), 0xC1.toByte(), 0x0C, 0x00, 0x05, 0x6B, 0x00, 0x00, 0x00, 0x00, 0xEF.toByte()),
        byteArrayOf(0xFE.toByte(), 0xDC.toByte(), 0xBA.toByte(), 0xC1.toByte(), 0x02, 0x00, 0x05, 0x6C, 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xEF.toByte()),
        byteArrayOf(0xFE.toByte(), 0xDC.toByte(), 0xBA.toByte(), 0xC1.toByte(), 0x09, 0x00, 0x05, 0x6D, 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xFF.toByte(), 0xEF.toByte())
    )
    ...
    fun buildPowerFrame(seq: Byte, mode: PowerMode): ByteArray {
        return byteArrayOf(
            0xFE.toByte(), 0xDC.toByte(), 0xBA.toByte(), 0xC1.toByte(), 0xF2.toByte(), 0x00, 0x06,
            seq, 0x04, 0x00, 0x40,
